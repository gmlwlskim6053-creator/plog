...
{
  "summary": "전체 프로젝트 현황 요약. 단순 나열이 아니라 '어떤 논의와 과정을 거쳐 지금 상태가 됐는지' 흐름과 맥락을 중심으로 5~8문장으로 서술. 주요 의사결정 배경, 변경이 있었다면 왜 바뀌었는지, 현재 남은 과제는 무엇인지를 포함할 것.",
  "milestones": [
  ...
  "sub_projects": [
    {
      ...
      "summary": "이 하위 프로젝트 현황 요약. 단순 현황 나열이 아니라 '어떤 논의와 과정을 거쳐 지금 상태가 됐는지' 흐름과 맥락 중심으로 4~6문장 서술. 주요 의사결정 배경, 변경이 있었다면 왜 바뀌었는지, 현재 남은 과제는 무엇인지를 포함할 것.",
...
- category는 이 프로젝트에서 해당 항목이 속하는 **고유 영역/테마** 이름으로 지정하세요. 항목의 성격(개발/홍보/법무)이 아니라, 프로젝트 내 실제 업무 영역(예: '홍보 페이지', '총판 접수', '심사', '문자 발송', '인프라', 'AI 엔진' 등)을 기준으로 AI가 스스로 판단하여 뽑아주세요. 같은 영역에 속하는 항목은 반드시 동일한 category명을 사용하세요.
- 없는 항목은 빈 배열로 반환하세요.
...
{
  "summary": "프로젝트 전체 현황 요약. 단순 나열이 아니라 '어떤 논의와 과정을 거쳐 지금 상태가 됐는지' 흐름과 맥락을 중심으로 5~8문장으로 서술. 주요 의사결정 배경, 변경이 있었다면 왜 바뀌었는지, 현재 남은 과제는 무엇인지를 포함할 것.",
